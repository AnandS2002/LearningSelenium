...
public class LoginTest {
	...
	private final String targeturl = "https://practicetestautomation.com/logged-in-successfully/";
	...
	void testPositiveLogin() {
		...
		assertEquals(targeturl, currentUrl, "Login failed: URL mismatch");
	...
	void testNegativeLoginPassword() {
		...
		assertTrue(element.isDisplayed(), "Error message  is not displayed");
	...
	void testNegativeLoginUser() {
		...
		assertTrue(element.isDisplayed(), "Error message is not displayed");
		assertEquals("Your username is invalid!", element.getText(), "Unknown Error");
